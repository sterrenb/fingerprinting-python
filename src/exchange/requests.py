...
class RequestGenerator:
    ...
    def create_requests(self):
        ...
        methods = [self.default_get, self.default_options, self.unknown_method, self.unauthorized_activity, self.empty_uri, self.malformed_method, self.unavailable_accept, self.long_content_length]
